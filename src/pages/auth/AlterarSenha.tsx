      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <button
            ...
            className="flex items-center gap-2 text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 text-sm mb-8 transition-colors"
          >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowAtual(!showAtual)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-900 dark:hover:text-slate-200">
