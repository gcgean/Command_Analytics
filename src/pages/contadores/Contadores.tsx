  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Contadores Parceiros</h1>
          <p className="text-slate-600 dark:text-slate-400 text-sm mt-1">{contadores.length} contadores carregados</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {filtrados.map((c: any) => (
          <div key={c.id}
            ...
            className="card cursor-pointer border transition-colors border-slate-200 dark:border-slate-700 hover:border-slate-600">
